...
:main_menu
     ...
     echo ANSI_5 "*--------------- " ANSI_12 "Dnyarri's macro runner script" ANSI_5 " --------------*"
     ...
     echo ANSI_11 "R" ANSI_9 "un macro.*"
     ...
     if ($chosen_option = "S")
            ...
            if ($file_loaded <> "") AND ($file_loaded <> 0)
                 delete $file_loaded
                 write $file_loaded "MACRO - dnyarri macro blaster"
