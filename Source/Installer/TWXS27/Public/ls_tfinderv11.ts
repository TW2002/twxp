	#	My first .TS Release - Remeber, I'm a Weekend Warrior Scriptor so don't expect much in the
	#							way of Prof. coding :)
	#
	#	JAN 8		Added invisible KeepAlive - #27 is sent every 2k sectors processed
	#
	setVar $CURENT_VERSION "1.1"
