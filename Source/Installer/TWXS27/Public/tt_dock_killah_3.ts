...
:warnings
gosub :egoBanner
echo ANSI_9 "**    " #42 #42 #42 ANSI_10 " Traitor's " ANSI_11 "PUBLIC Dock Killah, " ANSI_3 "version: " ANSI_11 $version " " ANSI_9 #42 #42 #42 "**"
...
if ($test = 0)
	...
	goto :getFigWave
elseif ($figwave < 1) OR ($figwave > 20000)
...
echo ANSI_10 "Press " ANSI_12 "q" ANSI_10 " to quit**"
:setAttackTriggers
