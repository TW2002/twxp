...
SetVar $prompt "ERROR"
If ($noecho = FALSE)
	Echo "**" & ANSI_12 & "Current Prompt is: " & $promptis
...
Send #145
WaitOn #145 & #8
GetWord CURRENTLINE $currentprompt 1
If ($currentprompt = "Computer") or ($currentprompt = "Corporate")
	Send "q"
	Goto :CURRENTPLANET
End
