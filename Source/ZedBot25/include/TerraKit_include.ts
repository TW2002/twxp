...
echo ansi_13 "     <" ansi_10 "#" ansi_13 ">  " ansi_14 "Check Who's Online" ansi_9 "            " ansi_13 "<" ansi_10 "Z" ansi_13 ">  " ansi_14 "C B Y and Die*"
echo ansi_13 "     ----------------------------------------------------------------------*"
:ask_terra
Echo "*"& ANSI_10 "Your choice? ("& ANSI_15 #34 ANSI_14 &"$"&  ANSI_15 #34 ANSI_10 &" to abort) "
